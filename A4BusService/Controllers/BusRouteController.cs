// File Name : BusRouteController.cs
// A full CRUD MVC Controller that shows and creates busRoute record
//
// Revision History : authorization edited by Sankgyun Park : Nov. 30, 2015
...
{
    //only signed on users can execute actions
    [Authorize]
    public class BusRouteController : Controller
    {
        ...
        // Index action is allowed to anonymous users
        [AllowAnonymous]
